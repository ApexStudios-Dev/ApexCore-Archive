...
public class RegistryEntryImpl<T> implements RegistryEntry<T>
{
    ...
    {
        RegistryApi.INSTANCE.addListener(getRegistryType(), getOwnerId(), registryName, listener);
    }
    ...
    public final Optional<Holder<T>> getHolderOptional()
    {
        ...
        return RegistryApi.INSTANCE.getDelegate(registrar.getRegistryType(), registryKey);
    }
