...
public interface TagUtil
{
    ...
    {
        return tag(registryType, GameData.FORGE_ID, tagPath);
    }
    ...
    {
        return blockTag(GameData.FORGE_ID, tagPath);
    }
    ...
    {
        return itemTag(GameData.FORGE_ID, tagPath);
    }
    ...
    {
        return entityTag(GameData.FORGE_ID, tagPath);
    }
