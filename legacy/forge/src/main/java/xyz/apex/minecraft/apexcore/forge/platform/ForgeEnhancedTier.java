...
public final class ForgeEnhancedTier implements EnhancedTier
{
    ...
    ForgeEnhancedTier(String registryName, int uses, float speed, float attackDamageBonus, int level, int enchantmentValue, Supplier<Ingredient> repairIngredient, @Nullable TagKey<Block> toolLevelTag)
    {
