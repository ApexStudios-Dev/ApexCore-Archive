...
public class RegistryEntryImpl<T> implements RegistryEntry<T>
{
    ...
    {
        RegistryHooks.get().addListener(getRegistryType(), getOwnerId(), registryName, listener);
    }
    ...
    public final Optional<Holder<T>> getHolderOptional()
    {
        ...
        return RegistryHooks.get().getDelegate(registrar.getRegistryType(), registryKey);
    }
