...
public final class ModEvents
{
    ...
    {
        // same method as to how minecraft-forge looks up the type internally
        // net.minecraftforge.eventbus.EventBus#getEventClass(Consumer) : L230
        // note to self: this is using a library minecraft-forge includes, so we cant make use of this library in common/fabric code without including it ourselves
