...
final class RegistryHooksImpl implements RegistryHooks
{
    ...
    {
        return RegistryHooks.findVanillaRegistry(registryType).flatMap(registry -> registry.getHolder(registryKey));
    }
    ...
    private static final class RegistryData<T>
    {
        ...
        private void register(String registrationName)
        {
            ...
            ApexCore.LOGGER.info(RegistrarManager.MARKER, "[{}] Registered registry entry '{}' of type '{}'", ownerId, registrationName, registryType.location());
