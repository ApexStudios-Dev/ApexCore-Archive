...
public final class QuiltEnhancedTier implements EnhancedTier
{
    ...
    QuiltEnhancedTier(String registryName, int uses, float speed, float attackDamageBonus, int level, int enchantmentValue, Supplier<Ingredient> repairIngredient, @Nullable TagKey<Block> toolLevelTag)
    {
