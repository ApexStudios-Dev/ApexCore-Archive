...
public class VillagerProfessionBuilder<T extends VillagerProfession, P> extends AbstractBuilder<VillagerProfession, T, P, VillagerProfessionBuilder<T, P>>
{
	...
	public PointOfInterestTypeBuilder<PointOfInterestType, VillagerProfessionBuilder<T, P>> poi()
	{
		return poi(PointOfInterestType::new);
	}
	...
	{
		secondaryPoi.addAll(Arrays.asList(secondaryPois));
		return this;
	}
	// endregion
	// endregion
	...
	{
		requestedItems.addAll(Arrays.asList(items));
		return this;
	}
	// endregion
	...
	/**
	 * Return correct language key designated by {@link VillagerEntity#getTypeName()}<br>
