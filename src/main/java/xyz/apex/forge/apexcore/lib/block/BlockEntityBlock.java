...
public abstract class BlockEntityBlock<T extends TileEntity> extends Block implements ITileEntityProvider
{
	public BlockEntityBlock(AbstractBlock.Properties properties)
	{
		super(properties);
	}
