...
public abstract class AbstractPacket
{
	 ...
	 * <br>
	 * The ({@link #AbstractPacket(PacketBuffer) decoder}) constructor below should always exist<br>
	 ...
	 * the {@link PacketBuffer buffer} is passed in so that any fields created in the<br>
