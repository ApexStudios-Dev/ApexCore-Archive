...
{
	public static final ProviderType<RegistrateTemplatePoolProvider> TEMPLATE_POOL = ProviderType.register(IMod.APEX_CORE.prefix("tempate_pool"), (p, e) -> new RegistrateTemplatePoolProvider(p, e.getGenerator()));
