...
{
	public static final ProviderType<RegistrateTemplatePoolProvider> TEMPLATE_POOL = ProviderType.register(ApexCore.ID + ":tempate_pool", (p, e) -> new RegistrateTemplatePoolProvider(p, e.getGenerator()));
