...
public class ApexRegistrator<REGISTRATOR extends ApexRegistrator<REGISTRATOR>> extends AbstractRegistrator<REGISTRATOR>
{
	...
	// region: MultiBlock
	protected final <MULTI_BLOCK extends MultiBlock, PARENT> MultiBlockBuilder<REGISTRATOR, MULTI_BLOCK, PARENT> multiBlockEntry(String registryName, PARENT parent, MultiBlockFactory<MULTI_BLOCK> multiBlockFactory, NonnullSupplier<BlockBehaviour.Properties> initialProperties, MultiBlockPattern pattern)
	{
	...
	{
		return multiBlockEntry(registryName, parent, multiBlockFactory, () -> BlockBehaviour.Properties.of(material), pattern);
	}
	...
	{
		return multiBlockEntry(registryName, parent, multiBlockFactory, () -> BlockBehaviour.Properties.of(material, materialColor), pattern);
	}
	...
	{
		return multiBlockEntry(registryName, parent, multiBlockFactory, () -> BlockBehaviour.Properties.of(material, materialColorFactory), pattern);
	}

	public final <MULTI_BLOCK extends MultiBlock, PARENT> MultiBlockBuilder<REGISTRATOR, MULTI_BLOCK, PARENT> multiBlock(String registryName, PARENT parent, NonnullSupplier<BlockBehaviour> blockProperties, MultiBlockFactory<MULTI_BLOCK> multiBlockFactory, MultiBlockPattern pattern)
	{
		return multiBlockEntry(registryName, parent, multiBlockFactory, () -> BlockBehaviour.Properties.copy(blockProperties.get()), pattern);
	}
	...
	public final <PARENT> MultiBlockBuilder<REGISTRATOR, MultiBlock, PARENT> multiBlock(String registryName, PARENT parent, NonnullSupplier<BlockBehaviour> blockProperties, MultiBlockPattern pattern)
	{
	...
	public final <MULTI_BLOCK extends MultiBlock> MultiBlockBuilder<REGISTRATOR, MULTI_BLOCK, REGISTRATOR> multiBlock(String registryName, NonnullSupplier<BlockBehaviour> blockProperties, MultiBlockFactory<MULTI_BLOCK> multiBlockFactory, MultiBlockPattern pattern)
	{
	...
	public final MultiBlockBuilder<REGISTRATOR, MultiBlock, REGISTRATOR> multiBlock(String registryName, NonnullSupplier<BlockBehaviour> blockProperties, MultiBlockPattern pattern)
	{
