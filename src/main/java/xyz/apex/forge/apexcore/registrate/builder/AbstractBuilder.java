...
public abstract class AbstractBuilder<
		...
		TYPE extends IForgeRegistryEntry<TYPE>,
		VALUE extends TYPE,
		PARENT,
...
> implements Builder<TYPE, VALUE, PARENT, BUILDER>
{
	...
	protected AbstractBuilder(OWNER owner, PARENT parent, String name, BuilderCallback callback, Class<? super TYPE> registerClassType, ResourceKey<Registry<TYPE>> registryType, BiFunction<OWNER, RegistryObject<VALUE>, ENTRY> registryEntryFactory, Function<RegistryEntry<VALUE>, ENTRY> registryEntryCaster)
	{
		this.owner = owner;
		this.parent = parent;
		this.name = name;
		...
		this.registryClassType = registerClassType;
	}
	...
	{
		return lang(translationKeyProvider, RegistrateLangProvider::<TYPE>getAutomaticName);
	}
	...
	@Override
	public final <OR extends IForgeRegistryEntry<OR>> BUILDER onRegisterAfter(ResourceKey<? extends Registry<OR>> dependencyType, NonNullConsumer<? super VALUE> callback)
	{
		return Builder.super.onRegisterAfter(dependencyType, callback);
	}

	@Override
	public final <TYPE2 extends IForgeRegistryEntry<TYPE2>, VALUE2 extends TYPE2, PARENT2, BUILDER2 extends Builder<TYPE2, VALUE2, PARENT2, BUILDER2>> BUILDER2 transform(NonNullFunction<BUILDER, BUILDER2> func)
	{
