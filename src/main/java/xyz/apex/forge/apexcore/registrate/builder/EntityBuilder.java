...
> extends AbstractBuilder<OWNER, EntityType<?>, EntityType<ENTITY>, PARENT, EntityBuilder<OWNER, ENTITY, PARENT>, EntityEntry<ENTITY>>
{
	...
	{
		super(owner, parent, name, callback, EntityType.class, ForgeRegistries.Keys.ENTITY_TYPES, EntityEntry::new, EntityEntry::cast);
	...
	public static <ENTITY extends Entity> void registerEntitySpawnPlacements(EntityType<ENTITY> entityType, SpawnPlacementData<ENTITY> spawnPlacementData)
	{
		...
		if(existingData != null)
			throw new IllegalStateException("Duplicate SpawnPlacement registration for type: %s".formatted(RegistryHelper.getRegistryName(ForgeRegistries.ENTITIES, entityType)));
	}
